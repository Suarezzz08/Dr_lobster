      ...
      <div className="row">
        ...
        <div className="Mx-Auto">
            ...
            <p className="text-center">
              ...
              <div>
              <h5 style={{marginTop: "25px"}}>Servicios de Emergencia a través del 112 (SAMUR, SUMMA).
</h5>
                </div>
              <h5 style={{marginTop: "25px"}}>Asociación Internacional del Teléfono de la Esperanza:
              ...
              <h5 style={{marginTop: "25px"}}>Teléfono de Prevención del Suicidio:
              900 925 555 
              ...
              Funciona las 24 horas.
              <h5 style={{marginTop: "25px"}}>UNIPSI: 915902654</h5>Centro de atención psicológica y psiquiátrica que está relacionado con la facultad de psicología de Comillas.
              <h5 style={{marginTop: "25px"}}></h5><a href="https://en.wikipedia.org/wiki/List_of_suicide_crisis_lines">LISTA DE LÍNEAS DE PAÍSES DEL MUNDO. INTERVENCIÓN EN CRISIS SUICIDAS</a>
